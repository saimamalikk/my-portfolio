...
export default function SkillsSection() {
  ...
  return (
    <section id="skills" className="relative py-24 md:py-36 bg-[#121210]">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="flex items-center sm:justify-center gap-2 mb-14 overflow-x-auto no-scrollbar pb-2 max-w-full px-2">
          {tabs.map((tab) => (
            <button
              key={tab}
          ...
          {filteredSkills.map((skill, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#1A1A18] p-6 rounded-2xl border border-[#ECE7E1]/10 hover:border-[#D4AF37]/50 transition-all duration-300 group flex flex-col justify-between"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="p-3 rounded-xl bg-[#121210] border border-[#D4AF37]/30 text-[#D4AF37] group-hover:bg-[#D4AF37] group-hover:text-[#121210] transition-colors">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] font-mono text-[#D4AF37] block mt-0.5 font-semibold">
                      Focus: {skill.focus}
                    </span>
                    <p className="text-xs text-[#A1A19A] leading-relaxed mt-2.5">
                      {skill.description}
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-4 mt-4 border-t border-[#ECE7E1]/10 flex items-center justify-between text-[11px] font-mono text-[#A1A19A]">
