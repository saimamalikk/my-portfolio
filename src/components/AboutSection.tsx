...
export default function AboutSection() {
  const highlights = [
    {
      icon: GraduationCap,
      title: "MCA Graduate",
      description: "Holds a Master of Computer Applications degree with strong foundations in software engineering and web technologies.",
    },
    {
      icon: Award,
  ...
  return (
    <section id="about" className="relative py-24 md:py-36 bg-[#121210]">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto mb-16">
          ...
          <p className="text-[#A1A19A] text-base sm:text-lg font-sans leading-relaxed">
            Recently graduated MCA professional with hands-on full-stack web development and data analytics experience.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 bg-[#1A1A18] p-8 sm:p-10 rounded-3xl border border-[#ECE7E1]/10 space-y-6">
            <h3 className="text-2xl sm:text-3xl font-serif font-bold text-[#ECE7E1]">
              Hello, I&apos;m Saima Kosser 👋
            </h3>
            
            <p className="text-[#A1A19A] text-sm sm:text-base leading-relaxed font-sans">
              I am an MCA graduate and full-stack web developer based in Jammu & Kashmir, India. I specialize in building modern, performant, and user-centric web applications using cutting-edge tools like Next.js, React, TypeScript, and PostgreSQL.
            </p>
            ...
            <div className="pt-4 border-t border-[#ECE7E1]/10 flex flex-wrap gap-6 text-xs font-mono text-[#D4AF37]">
              <div>
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {highlights.map((h, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[#1A1A18] p-5 rounded-2xl border border-[#ECE7E1]/10 hover:border-[#D4AF37]/40 transition-colors space-y-3"
                >
                  <div className="p-2.5 rounded-xl bg-[#121210] border border-[#D4AF37]/30 text-[#D4AF37] w-fit">
                    <Icon className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="text-base font-serif font-bold text-[#ECE7E1]">{h.title}</h4>
                    <p className="text-xs text-[#A1A19A] leading-relaxed mt-1">{h.description}</p>
                  </div>
                </div>
              );
            })}
