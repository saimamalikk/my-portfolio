      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          >
            ...
            {/* Status Monogram Tag */}
            <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-[#1A1A18] border border-[#D4AF37]/30 w-fit">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-serif font-bold text-[#ECE7E1] tracking-tight leading-[1.1] sm:leading-[1.08]">
                Saima <span className="text-gradient-gold">Kosser</span>
              </h1>
              
              <p className="text-base sm:text-xl md:text-2xl font-serif text-[#A1A19A] italic tracking-wide">
                Full-Stack Web Developer & Engineer
              </p>
            </div>

            {/* Editorial Biography / Value Proposition */}
            <p className="text-sm sm:text-base md:text-lg text-[#A1A19A] font-sans leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 text-[11px] sm:text-xs font-mono text-[#ECE7E1]">
              <span className="px-2.5 py-1.5 sm:px-3.5 sm:py-2 rounded-lg sm:rounded-xl bg-[#1A1A18] border border-[#ECE7E1]/10 flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="pt-2 space-y-3">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-8 sm:py-3.5 text-[11px] sm:text-xs font-mono uppercase tracking-wider text-[#ECE7E1] rounded-lg sm:rounded-xl bg-[#1A1A18] hover:bg-[#252522] border border-[#ECE7E1]/15 transition-all hover:scale-[1.02]"
                >
